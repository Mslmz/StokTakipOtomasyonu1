...
namespace stok_takip
{
    public partial class frmÜrünListele : Form
    {
        ...
        {
            baglanti.Open();
            OleDbCommand komut = new OleDbCommand("update urun set urunadi=@urunadi,miktar=@miktar,alisfiyati=@alisfiyati,satisfiyati=@satisfiyati where barkodno=@barkodno", baglanti);
